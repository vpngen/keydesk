...
// validatePriorityOp carries out validations for parameter PriorityOp
func (o *GetMessagesParams) validatePriorityOp(formats strfmt.Registry) error {

	if err := validate.EnumCase("priority-op", "query", *o.PriorityOp, []any{"eq", "ne", "gt", "lt", "ge", "le"}, true); err != nil {
		return err
	}
...
// validateSortPriority carries out validations for parameter SortPriority
func (o *GetMessagesParams) validateSortPriority(formats strfmt.Registry) error {

	if err := validate.EnumCase("sort-priority", "query", *o.SortPriority, []any{"asc", "desc"}, true); err != nil {
		return err
	}
...
// validateSortTime carries out validations for parameter SortTime
func (o *GetMessagesParams) validateSortTime(formats strfmt.Registry) error {

	if err := validate.EnumCase("sort-time", "query", *o.SortTime, []any{"asc", "desc"}, true); err != nil {
		return err
	}
