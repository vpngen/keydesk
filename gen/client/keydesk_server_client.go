...
// Default keydesk server HTTP client.
...
// NewHTTPClient creates a new keydesk server HTTP client.
func NewHTTPClient(formats strfmt.Registry) *KeydeskServer {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new keydesk server HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *KeydeskServer {
...
// New creates a new keydesk server client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *KeydeskServer {
	// ensure nullable parameters have default
	if formats == nil {
		formats = strfmt.Default
	}

	cli := new(KeydeskServer)
...
// KeydeskServer is a client for keydesk server.
type KeydeskServer struct {
...
func (c *KeydeskServer) SetTransport(transport runtime.ContextualTransport) {
