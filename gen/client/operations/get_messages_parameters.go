...
func NewGetMessagesParams() *GetMessagesParams {
	return NewGetMessagesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetMessagesParams].
...
func (o *GetMessagesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Priority != nil {
		...
		qPriority := conv.FormatInteger(qrPriority)
		if qPriority != "" {
