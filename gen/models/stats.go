...
func (m *Stats) validateActiveUsers(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.ActiveUsers); i++ {
		if typeutils.IsZero(m.ActiveUsers[i]) { // not required
			continue
		}
...
func (m *Stats) validateTotalTrafficGB(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.TotalTrafficGB); i++ {
		if typeutils.IsZero(m.TotalTrafficGB[i]) { // not required
			continue
		}
...
func (m *Stats) validateTotalUsers(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.TotalUsers); i++ {
		if typeutils.IsZero(m.TotalUsers[i]) { // not required
			continue
		}
...
func (m *StatsActiveUsersItems0) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
...
func (m *StatsTotalTrafficGBItems0) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
...
func (m *StatsTotalUsersItems0) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
